% Instructions for EVEN NUMBERED participants; LEFT Attracts
...
RewardIntro = sprintf(['This is the +1 reward you will see when you correctly predicted\n'...
    ...
    'i.e. If you press the left arrow to indicate the mating call/dance\n'...
    'WAS successful when in fact the insect DID attract a partner,\n'...
    'or press the right arrow to indicate that the mating call/dance \n'...
...
NoRewardIntro = sprintf(['This is the 0 reward you will see when your prediction was incorrect,\n'...
    'either by pressing the left arrow to indicate the mating call/dance WAS successful\n'...
    'when in fact it WAS NOT, or by pressing the right arrow to indicate\n'...
...
summarySlide = sprintf(['SUMMARY\n\n\n'...
    ...
    '2. You then predict whether the insect will attract a partner (Left Arrow) or not (Right).\n\n'...
