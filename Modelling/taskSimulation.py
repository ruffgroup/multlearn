...
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 0, 0])
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 0, 1])
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 0, 2])
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 1, 0])
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 1, 1])
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 1, 2])
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 2, 0])
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 2, 1])
# plt.plot(range(0, taskSimulation.mainTrials), taskSimulation.rewardPE[:, 2, 2])
# plt.legend(bbox_to_anchor=(1.15, 0.65))
# plt.xlabel("Trials")
# plt.ylabel("Reward Prediction error")
# plt.title("Reward rediction error signal")
# fig1 = plt.gcf()
# plt.show()
# plt.draw()
