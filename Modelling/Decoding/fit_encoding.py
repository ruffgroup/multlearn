...
def plot_encoding_ind(subject, r2_img, space="T1w", bids_folder="/mnt/d/data/ds-mlearn"):
    ...
    plotting.plot_stat_map(r2_img, space_img, threshold=0.01, output_file=f"sub-{subject:02d}_{space}_r2.png")
...
def main(
    ...
    target_dir = op.join(
        bids_folder, "derivatives", "encoding_model", f"sub-{subject:02d}", "func", space
    )
