function func_level1_ROI(folder_processed, bids_folder, SPM_folder, sub, model_version, ROI_folder, splitting, ROI)
...
%path of results
data.destination = string(fullfile(SPM_folder,'/results',model_version,'ROI_analysis', ROI_folder, ROI_name, splitting, sub));
