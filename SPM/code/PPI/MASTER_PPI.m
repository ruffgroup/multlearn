...
ISrun_level2SnPM_PPI = 1;
ISrun_level2Inference_PPI = 1;
...
% subs = subs(contains({subs.name},{'sub-01', 'sub-02', 'sub-03', 'sub-04', 'sub-05', 'sub-06', 'sub-07', ...
%     'sub-09', 'sub-10', 'sub-11', 'sub-12', 'sub-14', 'sub-15', 'sub-16', 'sub-17', 'sub-18', ...
%     'sub-19', 'sub-20', 'sub-21', 'sub-22', 'sub-23', 'sub-24', 'sub-25', 'sub-26', 'sub-27', ...
%     'sub-28', 'sub-29', 'sub-30', 'sub-31', 'sub-32', 'sub-33'}));
%subs = subs(contains({subs.name},{'sub-34'}));
...
for i = models
    ...
    if ISrun_PPI == 1
        ...
        parfor (sub = 1:numSubs,M)
%             try
%               func_get_PPI(path.SPM_folder, model_version, char(model(1,1)),subs(sub).name, 'choice', ROI_choice_folder(1),0)
%             catch
%             end
            for ROI = ROI_choice_folder'
                try
